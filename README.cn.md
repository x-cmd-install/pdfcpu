...
合计: **231,286** 行代码（覆盖前 5 种语言、共 **730** 个文件）。
...
- **Star**: 8,831 · **Fork**: 626 · **开放 issue**: 1,108 · **贡献者**: 54

## 累计统计

- **发布数**: 71 · **已合并 PR**: 89 · **开放 PR**: 4 · **已关闭 issue**: 992 · **开放 issue**: 116 · **提交数**: 1122
...
在 [repology.org](https://repology.org/project/pdfcpu) 上共有 **19** 个发行版报告此项目。**9** 个 ✅ 已是最新上游版本，**10** 个 ⚠️ 使用旧版本。
...
_数据快照: `data/card/260912.yml` · 2026-09-12T04:36:15Z._
